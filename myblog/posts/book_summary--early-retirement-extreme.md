...
Like [Plato's cave](https://en.wikipedia.org/wiki/Allegory_of_the_Cave), most people follow a common life track: school → university → career. This path is not efficient.
...
[What is ergodicity?](https://www.barbellstrategy.com/blog/post-9mwgp-gw568) Space average equals time average. If you look at one point over time, you get the same answer as looking at all space at one time.
...
- Study the structure and principles of different systems to build a collection of models for understanding other systems.
...
- Gain maximum satisfaction with minimum expenditure of money and energy.
### Things
