...
---
Presentation is
[here](https://github.com/raganwald/presentations/blob/master/optimism.md).

Optimism is the way we explain things that happened to us. There is no
one \"correct\" way, since they are just different interpretations from
the same information/situation.
