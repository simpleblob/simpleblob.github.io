...
importance: 1
---
An economy is simply a sum of transaction. A market is sum of
transactions for the same thing (ex: wheat, gold, property)

A transaction consists of a buyer giving money or credit to a seller in
exchange of goods, services, or financial assets.

For any market or economy, if we know the total amount of money (or
credit) spent, and the total quantity sold, then we know everything
